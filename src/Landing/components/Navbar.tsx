...
const iconSvg = {
    instagram: (
        <svg width="clamp(18,2vw,24)" height="clamp(18,2vw,24)" fill="none" viewBox="0 0 24 24" style={{ width: 'clamp(18px,2vw,24px)', height: 'clamp(18px,2vw,24px)' }}>
    ...
    facebook: (
        <svg width="clamp(18,2vw,24)" height="clamp(18,2vw,24)" viewBox="0 0 24 24" fill="none" style={{ width: 'clamp(18px,2vw,24px)', height: 'clamp(18px,2vw,24px)' }}>
    ...
    return (
        <nav
            style={{
                ...
                fontFamily: "inherit",
                minHeight: "clamp(70px, 9vw, 172px)",
                padding: 0,
            }}
        >
            <div
                    ...
                    {navLinksKeys.map((link) => (
                        <a
                            ...
                            style={{
                                ...
                                letterSpacing: 0.5,
                                textDecoration: "none",
                                borderBottom: link.active ? "2px solid #222" : "none",
